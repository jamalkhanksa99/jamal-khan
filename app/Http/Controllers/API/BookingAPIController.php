    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $this->validate($request, [
                ...
                'booking_type' => 'integer|min:1|max:2',
            ]);
            ...
            $input['payment']['description'] = __('lang.payment_booking_id') . $booking->id;
            $input['payment']['payment_method_id'] = 6;
            ...
            $booking = $this->bookingRepository->update(['payment_id' => $payment->id], $booking->id);
