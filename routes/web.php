...
Route::post('webhooks/sms', 'WebhooksController@smsLog')->name('webhooks.sms');

Route::get('app/reset', function () {
    Auth::logout();
    return view('auth.passwords.appReset');
});
...
/* START - Moyasar Payment */
Route::get('payments/moyasar/process', 'MoyasarController@process');
// Callbacks
Route::get('payments/moyasar/service-order-callback', 'MoyasarController@serviceOrderCallback');
/* END - Moyasar Payment */
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('notificationMessages', 'NotificationMessageController')->except([
        'edit'
    ]);
    ...
    Route::resource('customerReviews', 'CustomerReviewController')->except([
        'create', 'edit'
    ]);
    ...
    Route::resource('complains', 'ComplainController')->except([
        'create'
    ]);
});
