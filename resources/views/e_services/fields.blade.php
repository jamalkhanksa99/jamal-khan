...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Capacity Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('capacity', trans("lang.e_service_capacity"), ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::number('capacity', null, ['class' => 'form-control','step'=>'1', 'min'=>'1', 'placeholder'=> trans("lang.e_service_capacity_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.e_service_capacity_help") }}
            </div>
        </div>
    </div>
...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- In Center Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('in_center', trans("lang.e_service_in_center"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!} {!! Form::hidden('in_center', 0, ['id'=>"hidden_in_center"]) !!}
        <div class="col-md-9 icheck-{{setting('theme_color')}}">
            {!! Form::checkbox('in_center', 1, null) !!} <label for="in_center"></label>
        </div>
    </div>
    <!-- In Home Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('in_home', trans("lang.e_service_in_home"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!} {!! Form::hidden('in_home', 0, ['id'=>"hidden_in_home"]) !!}
        <div class="col-md-9 icheck-{{setting('theme_color')}}">
            {!! Form::checkbox('in_home', 1, null) !!} <label for="in_home"></label>
        </div>
    </div>
</div>
@if($customFields)
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    ...
    <a href="{!! route('eServices.index') !!}" class="btn btn-default"><i
