...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Booking Type Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('booking_type', trans("lang.booking_booking_type"),['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
        <div class="col-md-9">
            {!! Form::select('booking_type', [1=>trans('lang.' . \App\Models\Booking::$types[1]), 2=>trans('lang.' . \App\Models\Booking::$types[2])], null, ['class' => 'select2 form-control']) !!}
        </div>
    </div>
</div>
@if($customFields)
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    ...
    <a href="{!! route('bookings.index') !!}" class="btn btn-default"><i
