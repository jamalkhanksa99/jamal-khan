...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-bold">{{trans('lang.booking_plural')}} <small
                                class="mx-3">|</small><small>{{trans('lang.booking_desc')}}</small></h1>
                </div><!-- /.col -->
                <div class="col-md-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        <li class="breadcrumb-item"><a href="{{url('/')}}"><i
                                        class="fas fa-tachometer-alt"></i> {{trans('lang.dashboard')}}</a></li>
                        <li class="breadcrumb-item active"><a
                                    href="{!! route('bookings.index') !!}">{{trans('lang.booking_plural')}}</a>
                        </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('bookings.index') !!}"><i
                                        class="fa fa-list mr-2"></i>{{trans('lang.booking_table')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{!! route('bookings.show',$booking->id) !!}"><i
                                        class="fas fa-calendar-check mr-2"></i>{{trans('lang.booking_details')}}
                            </a>
                        </li>
                        @can('bookings.edit')
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('bookings.edit',$booking->id) !!}"><i
                                            class="fas fa-edit mr-2"></i>{{trans('lang.booking_edit')}}
                                </a>
                            </li>
                        @endcan
                    </ul>
                ...
                <div class="card-body p-0">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex flex-column mx-3">
                                ...
                                <span><b>{{$booking->e_service->name}}</b><small
                                            class="mx-3">{{__('lang.by')}} {{$booking->e_provider->name}}</small></span>
                            </div>
                        ...
                        @foreach($booking->options as $option)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="mx-3"><b>{{$option->name}}</b><small
                                            class="mx-3"> {{getStripedHtmlColumn($option,'description')}}</small></span>
                    ...
                    <div class="d-flex flex-column flex-md-row">
                        ...
                        <ul class="list-group list-group-flush col-12 col-lg-5 p-0">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><b>{{$booking->coupon->code}}</b><small
                                            class="mx-3"> {{getStripedHtmlColumn($booking->coupon,'description')}}</small></span>
                                <h6 class="text-bold ml-xl-auto my-1 my-xl-0">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <b>{{__('lang.booking_subtotal')}}</b> <h6
                                        class="text-bold">{!! getPrice($booking->getSubtotal()) !!}</h6>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <b>{{__('lang.booking_total')}}</b> <h5
                                        class="text-bold">{!! getPrice($booking->getTotal()) !!}</h5>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
                        <a href="#" class="btn btn-default mx-md-2 my-md-0 my-2"> <i
                                    class="fas fa-print"></i> {{trans('lang.print')}}
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex flex-xl-row flex-column justify-content-between align-items-center align-items-xl-start px-0">
                            ...
                            <div class="d-flex flex-column align-items-center align-items-xl-start mx-2 my-1 my-xl-0 my-0">
                                <b>{{$booking->user->name}}</b> <small>{{$booking->user->email}}</small>
                                <small>{{$booking->user->phone_number}}</small>
                            </div>
                            <a target="_blank" class="btn btn-sm btn-default ml-xl-auto my-1 my-xl-0"
                               href="{{route('users.edit',$booking->user->id)}}"><i
                                        class="fas fa-user-alt mx-1"></i>{{__('lang.user_profile')}}
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="card-body px-0 py-1">
                    <ul class="list-group list-group-flush">
                        @if($booking->booking_type != 0)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <b>{{__('lang.booking_booking_type')}}</b>
                                <small>{{trans('lang.'.\App\Models\Booking::$types[$booking->booking_type])}}</small>
                            </li>
                        @endif
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a target="_blank" class="btn btn-sm btn-default"
                               href="{{'https://www.google.com/maps/@'.$booking->address->latitude .','.$booking->address->longitude.',14z'}}"><i
                                        class="fas fa-directions mx-1"></i>{{__('lang.address_google_maps')}}
                            </a>
                        </li>
                    </ul>
                </div>
