...
@can('modules.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('modules*') ? 'active' : '' }}"
           href="{!! route('modules.index') !!}">@if($icons)
...
@if(!Module::isActivated('Subscription'))
    <li class="nav-item {{ Request::is('notificationMessages*') || Request::is('notifications*') ? 'menu-open' : '' }}">
        <a href="#"
           class="nav-link {{ Request::is('notifications*') || Request::is('notificationMessages*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-bell"></i>
            @endif
            <p>{{trans('lang.notification_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('notificationMessages.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('notificationMessages*') ? 'active' : '' }}"
                       href="{!! route('notificationMessages.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-folder-open"></i>
                        @endif<p>{{trans('lang.notification_message_plural')}}</p></a>
                </li>
            @endcan
...
<li class="nav-item has-treeview {{ Request::is('bookings*') || Request::is('bookingStatuses*') || Request::is('deliveryAddresses*')? 'menu-open' : '' }}">
    ...
    <ul class="nav nav-treeview">
        ...
        @endcan
        @can('customerReviews.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('customerReviews*') ? 'active' : '' }}"
                   href="{!! route('customerReviews.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-comments"></i>
                    @endif<p>{{trans('lang.customer_review_plural')}}</p></a>
            </li>
        @endcan
...
@can('complains.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('complains*') ? 'active' : '' }}"
           href="{!! route('complains.index') !!}">@if($icons)
                <i class="nav-icon fas fa-inbox"></i>
            @endif<p>{{trans('lang.complain_plural')}} </p></a>
    </li>
@endcan
@can('coupons.index')
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('subscriptionPackages*') ? 'active' : '' }}"
               href="{!! route('subscriptionPackages.index') !!}">@if($icons)
                ...
                @endif<p>{{trans('subscription::lang.subscription_package_plural')}}@if (config('installer.demo_app'))
    ...
    @can('eProviderSubscriptions.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('eProviderSubscriptions*') ? 'active' : '' }}"
               href="{!! route('eProviderSubscriptions.index') !!}">@if($icons)
                    <i class="nav-icon fa fa-address-card"></i>
                @endif
                <p>{{trans('subscription::lang.e_provider_subscription_plural')}}@if (config('installer.demo_app'))
                        <span class="right badge badge-danger">Addon</span>
                    @endif</p></a>
        </li>
    @endcan
